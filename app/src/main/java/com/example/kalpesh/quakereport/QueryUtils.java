...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray ethArray = jObj.getJSONArray("features") ;
            for(int i = 0  ;i<10 ; i++){
                JSONObject eathObj = ethArray.getJSONObject(i).getJSONObject("properties") ;
                Double mag = eathObj.getDouble("mag") ;
                String place = eathObj.getString("place") ;
                Long milliseconds = eathObj.getLong("time") ;
                //Log.v("Date: ",milliseconds.toString());
                earthquakes.add(new Earthquake(place ,mag ,milliseconds));
            }
